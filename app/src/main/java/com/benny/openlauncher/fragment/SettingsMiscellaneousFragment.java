...
public class SettingsMiscellaneousFragment extends SettingsBaseFragment {
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (key == R.string.pref_key__backup) {
            ...
            return true;
        } else if (key == R.string.pref_key__restore) {
            if (new PermissionChecker(getActivity()).doIfExtStoragePermissionGranted()) {
                Intent i = new Intent(getActivity(), FilePickerActivity.class)
            ...
            return true;
        } else if (key == R.string.pref_key__reset_settings) {
            ...
            return true;
        } else if (key == R.string.pref_key__reset_database) {
            ...
            return true;
        } else if (key == R.string.pref_key__restart) {
            homeActivity.recreate();
            getActivity().finish();
            return true;
        }
